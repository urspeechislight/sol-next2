...
``_API_BASE_URL`` names the local FastAPI backend this server proxies. It is a
module constant, not an env read: CENTRAL-001 stays satisfied and this server
carries no dependency on the backend's required ``SOL_BOOKS_DIR`` setting.
"""
