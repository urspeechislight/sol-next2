...
export type IconName =
  | "library" | "reader" | "graph" | "daily" | "search" | "sun" | "moon"
  | "chevron-left" | "chevron-right" | "chevron-down" | "chevron-up"
  | "close" | "arrow-right" | "external" | "scroll" | "star" | "node"
  | "layers" | "grid" | "info" | "quote" | "filter" | "pin" | "compass"
  | "menu" | "book" | "calendar" | "sparkle" | "settings" | "gear" | "check" | "link"
  | "minus" | "plus" | "chevrons-left" | "chevrons-right" | "arrow-left" | "network"
  | "share" | "copy" | "download" | "qr" | "x" | "instagram" | "facebook" | "tiktok"
  | "type" | "text-size" | "bookmark" | "clock" | "globe" | "tag" | "users" | "eye"
  | "sliders" | "bell" | "maximize" | "highlighter" | "note";
...
export const ICON_PATHS: Record<IconName, string> = {
  ...
  graph: "M6 7a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM18 9a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM18 21a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM6 17a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM8 6.5l8 0M7.5 12.5l9 4M8 13l8-6",
  ...
  scroll: "M8 3h10a2 2 0 012 2v12a2 2 0 01-2 2H8M8 3a2 2 0 00-2 2v12a2 2 0 01-2 2h12M8 7h8M8 11h8M8 15h5",
  ...
  settings: "M12 9a3 3 0 100 6 3 3 0 000-6zM19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 11-2.83 2.83l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 11-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 11-2.83-2.83l.06-.06a1.65 1.65 0 00.33-1.82 1.65 1.65 0 00-1.51-1H3a2 2 0 110-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 112.83-2.83l.06.06a1.65 1.65 0 001.82.33H9a1.65 1.65 0 001-1.51V3a2 2 0 114 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 112.83 2.83l-.06.06a1.65 1.65 0 00-.33 1.82V9a1.65 1.65 0 001.51 1H21a2 2 0 110 4h-.09a1.65 1.65 0 00-1.51 1z",
  ...
  network: "M6 7a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM18 9a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM18 21a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM6 17a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM8 6.5l8 0M7.5 12.5l9 4M8 13l8-6",
