...
export type { TextProps, TextAs, TextWeight } from "./primitives/Text";

export { Heading } from "./primitives/Heading";
export type { HeadingProps, HeadingLevel } from "./primitives/Heading";

export { Stack } from "./primitives/Stack";
export type { StackProps, Gap, Align, Justify } from "./primitives/Stack";

export { Inline } from "./primitives/Inline";
export type { InlineProps, InlineAlign } from "./primitives/Inline";
